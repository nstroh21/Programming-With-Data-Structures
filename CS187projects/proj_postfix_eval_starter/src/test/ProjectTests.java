...
public class ProjectTests {
  ...
  public void testEvaluateSimplePublic() throws Exception {
  	Integer result = evaluator.evaluate("100");
  ...
  /*@Test
  public void testArithPostfixEvaluator() {
	String expr = "1234+++";
	ArithPostfixEvaluator eval = new ArithPostfixEvaluator();
	Integer answer = eval.evaluate(expr);
