...
public class ProjectTests {
  ...
  @Test 
  public void compressLineTest0()  {
    char [] fileChars = {'0','1'};
    String line = "0001100000110000";
    String correctRes = "3,2,5,2,4";
  ...
  @Test 
  public void decompressLineTest7()  {
    char[] fileChars = {'_','$'};
    String line = conv.compressLine("$$$$$$$__________$$_______$$_$$$$$$$$$$_", fileChars);// "9,14,14"; 
    String correctRes = "$$$$$$$__________$$_______$$_$$$$$$$$$$_";
    String actualRes = conv.decompressLine(line, fileChars);
    assertEquals("Test 14: Test the decompressLine method.", correctRes, actualRes);
  }  
