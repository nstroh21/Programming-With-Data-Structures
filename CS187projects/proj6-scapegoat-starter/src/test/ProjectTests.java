...
public class ProjectTests {
  ...
  public void testEquals() {
    ...
    tree.add(new String("bar"));
    oneNodeTree.add(new String("bar"));
    oneNodeTree.add(new String("penguin"));
    tree.add(new String("penguin"));
    tree.add(new String("zoo penguin"));
    assertFalse(oneNodeTree.equals(tree));
  }
  ...
  @Test
  public void testScapegoatAddBiFurcate() {
    tree.add(5);
    tree.add(4);
    tree.add(3);
    tree.add(2);
    ...
    assertEquals(4, tree.height());
    tree.add(0);
    // 6 nodes --> scapeLim should equal 4.41
    assertEquals(4, tree.height());
  }
